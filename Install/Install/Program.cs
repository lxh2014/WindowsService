...
namespace MyInstallFirstWindowsService
{
    class Program
    {
        ...
        {
            Console.WriteLine("Service is installging... ");
            ...
            try
            {
                ...
                else
                {
                    ...
                    Console.WriteLine("install is failed !");
                    Thread.Sleep(3000);
                    return;
                }
            ...
            try
            {
                ...
                if (File.Exists(serviceEXEPath))
                {
                    Console.WriteLine("File :" + serviceEXEPath + " is loading... ");
            ...
            try
            {
                ...
                if (sc != null)
                {
                    ...
                    {
                        Console.WriteLine("-------------------------------------------");
                        Console.WriteLine("install is successed !");
                        sc.Start();
                    ...
                    {
                        Console.WriteLine("Service has been launched");
                        Thread.Sleep(3000);
                    }
                }
